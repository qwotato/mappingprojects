...
nsidevperpchange <-ggplot(cookchange)+
  geom_sf(aes(fill=vchange))+
  scale_fill_stepsn(name="2010 to 2020 Change In \nVehicles Per Person",labels=scales::label_percent(),colours = c("darkgreen","#57bc65", "#c3eac9","#fdfb66", "orange","darkred"),
...
ggsave(plot=nsidevperpchange, "nsidevperpchange.jpg",height=11,width=8.5)


cookvperpchange <-ggplot(cookchange)+
  geom_sf(aes(fill=vchange))+
  scale_fill_stepsn(name="2010 to 2020 Change In \nVehicles Per Person",labels=scales::label_percent(),colours = c("darkgreen","#57bc65", "#c3eac9","#fdfb66", "orange","darkred"),
                    values = scales::rescale(c(-0.25,-0.2,-0.15, -0.1,-0.05, 0,0.05, 0.1,0.15, 0.2, 0.25)))+
...
ggsave(plot=cookvperpchange, "cookvperpchange.jpg",height=11,width=8.5)


#################################################################################################################################
#Commuter Vehicles Per Person

cookvperp <- ggplot(cookchange)+
  geom_sf(aes(fill=vofp))+
  scale_fill_stepsn(name="Commuter Vehicles Per Person",colours = c("darkgreen","#57bc65", "#c3eac9","#fdfb66", "orange","darkred"),
                    values = scales::rescale(c(-0.25,-0.2,-0.15, -0.1,-0.05, 0,0.05, 0.1,0.15, 0.2, 0.25)))+
  geom_sf(data=chicago,fill=NA,color="black",linewidth=0.8)+
...
ggsave(plot=cookvperp, "cookvperp.jpg",height=11,width=8.5)
